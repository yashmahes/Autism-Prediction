...
root = Tk()
root.title("Autism Spectrum Disorder Classification")
width = 400
height = 280
...
def HomeWindow():
    ...
    root.withdraw()
    Home = Toplevel()
    Home.title("Autism Spectrum Disorder Classification")
    width = 600
    height = 500
    screen_width = root.winfo_screenwidth()
    screen_height = root.winfo_screenheight()
    ...
    Label(Home, text="Successfully Login!",
                     font=('times new roman', 20)).pack()
    Button(Home, text='logout', command=logout).pack(pady=20, fill=X)
...
# ==============================LABELS=========================================
lbl_title = Label(
    Top, text="Autism Spectrum Disorder Classification", font=('arial', 15))
